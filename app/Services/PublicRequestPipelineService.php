        ...
        return DB::transaction(function () use ($public) {
            ...
            if ($public->request_type === 'QUOTATION') {
                $lead = CrmLead::create([
                    ...
                    'name'=>$public->company_name,'company'=>$public->company_name,'email'=>$public->email,'mobile'=>$public->mobile,
                ...
                $links += ['crm_lead_id'=>$lead->id,'crm_opportunity_id'=>$opportunity->id,'crm_quotation_id'=>$quotation->id,'status'=>'CONVERTED_TO_QUOTATION'];
            } else {
                ...
                $workOrder = WorkOrder::create([
                    ...
                    'asset_id'=>$asset->id,'maintenance_type'=>'CORRECTIVE','priority'=>'EMERGENCY','status'=>'OPEN','planned_start'=>$plannedStart,
                ]);
                ...
                $serviceRequest = ServiceRequest::create([
                    ...
                    'site_city'=>$public->site_city,'priority'=>'EMERGENCY','status'=>'OPEN','work_order_id'=>$workOrder->id,
                ]);
