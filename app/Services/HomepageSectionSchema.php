...
class HomepageSectionSchema
{
    ...
    public static function fields(string $sectionKey): array
    {
        return match ($sectionKey) {
            'hero' => [
                'scalars' => ['display_mode', 'render_mode', 'full_section_image', 'image', 'eyebrow', 'title', 'text', 'button'],
                'items' => [
            ...
            'about' => [
                'scalars' => [
                    'display_mode', 'full_section_image', 'image', 'kicker', 'title', 'text', 'button',
                    'page_visual_image',
                    'page_strapline',
                    'page_eyebrow',
                    'page_title',
