...
class PublicServiceRequest extends Model
{
    protected $fillable = [
        ...
        'requested_date','requested_time','equipment_image_path','equipment_photo_paths','problem_photo_paths','supporting_image_paths','supporting_document_paths','previous_report_paths','video_attachment_path',
