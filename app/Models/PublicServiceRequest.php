...
{
    protected $fillable = [
        'reference_no','request_type','request_intent','service_category','service_family','asset_type','subject','details','site_city','site_address','latitude','longitude','urgency',
        'requested_date','requested_time','equipment_image_path','supporting_image_paths','supporting_document_paths',
