...
class ServiceRequest extends Model
{
    ...
    protected $fillable = [
        'tenant_id','organization_id','customer_id','customer_site_id','service_contract_id','asset_id','operational_domain_id','assigned_engineer_id','operations_manager_id','operations_routing_status','request_no','request_type','request_subtype','company_name','commercial_registration','email','mobile',
