...
{
    protected $fillable = ['tenant_id', 'approval_type', 'role_id', 'user_id', 'level', 'access_scope_id', 'amount_from', 'amount_to', 'amount_limit', 'conditions', 'is_active', 'configured_by'];
