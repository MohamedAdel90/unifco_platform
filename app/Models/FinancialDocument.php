...
{
    use BelongsToTenant;
    protected $fillable=['tenant_id','organization_id','document_no','document_type','counterparty_name','document_date','due_date','currency','amount','control_account_code','offset_account_code','status','created_by','posted_by','journal_id','posted_at','open_amount'];
