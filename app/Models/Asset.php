...
{
    use BelongsToTenant;
    protected $fillable = ['tenant_id','organization_id','parent_asset_id','asset_code','name','location_code','serial_no','warranty_expiry','acquisition_cost','salvage_value','useful_life_months','accumulated_depreciation','net_book_value','meter_value','commission_date','disposed_at','status'];
