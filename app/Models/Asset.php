...
class Asset extends Model
{
    ...
    protected $fillable = [
        'tenant_id','organization_id','customer_id','customer_site_id','parent_asset_id','asset_category_template_id','asset_code','customer_asset_code','name','location_code','serial_no',
        ...
        'meter_value','commission_date','supplier_name','installer_name','qr_token','verification_status','data_completeness_score','verified_by','verified_at','verification_notes',
