...
{
    use BelongsToTenant;
    protected $fillable=['tenant_id','organization_id','project_id','created_by','approved_by','supplier_id','purchase_requisition_id','po_number','supplier_name','order_date','total','status'];
