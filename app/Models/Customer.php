...
class Customer extends Model
{
    ...
    protected $fillable = [
        ...
        'phone','city','country','address','status','onboarding_status','acquisition_source','origin_lead_id','first_touch_at','converted_by','converted_at'
    ];

    protected function casts(): array { return ['first_touch_at'=>'datetime','converted_at'=>'datetime']; }
