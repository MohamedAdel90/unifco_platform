...
class EmploymentContract extends Model
{
    ...
    protected $fillable = [
        ...
        'basic_salary','housing_allowance','transport_allowance','other_allowances','currency','status','signed_on','created_by',
    ];

    protected function casts(): array
    {
        return [
            'starts_on'=>'date','ends_on'=>'date','probation_ends_on'=>'date','signed_on'=>'date',
