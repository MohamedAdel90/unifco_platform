...
use App\Models\{AttendanceEntry,Employee,EmployeeDocument,EmploymentContract,LeaveRequest,PayrollRun};
    ...
    public function index(Request $request): View
    {
        ...
        return view('hr.dashboard',[
            'stats'=>[
                ...
                'monthly_compensation'=>$payrollLiability,
            ],
            'pendingLeaves'=>$pendingLeaves,'latestPayroll'=>$latestPayroll,'expiringContracts'=>$expiringContracts,
            'expiringDocuments'=>$expiringDocuments,'departments'=>$departments,'today'=>$today,
        ]);
    }
}
