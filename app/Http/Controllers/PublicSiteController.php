...
HTML;
    ...
    public function store(Request $request, PublicRequestPipelineService $pipeline): RedirectResponse
    {
        ...
        $data=$request->validate([
            'request_intent'=>['required','in:QUOTATION,SERVICE_REQUEST,CONSULTATION'],'request_subtype'=>['required','in:SPARE_PARTS_QUOTE,MAINTENANCE_CONTRACT_QUOTE,TECHNICAL_VISIT,ROUTINE_MAINTENANCE,URGENT_MAINTENANCE,TECHNICAL_CONSULTATION'],
        ...
        $subtypeIntent=['SPARE_PARTS_QUOTE'=>'QUOTATION','MAINTENANCE_CONTRACT_QUOTE'=>'QUOTATION','TECHNICAL_VISIT'=>'QUOTATION','ROUTINE_MAINTENANCE'=>'SERVICE_REQUEST','URGENT_MAINTENANCE'=>'SERVICE_REQUEST','TECHNICAL_CONSULTATION'=>'CONSULTATION'];
        ...
        $data['request_type']=match($data['request_subtype']){'SPARE_PARTS_QUOTE','MAINTENANCE_CONTRACT_QUOTE','TECHNICAL_VISIT'=>'QUOTATION','URGENT_MAINTENANCE'=>'EMERGENCY_MAINTENANCE','ROUTINE_MAINTENANCE'=>'SERVICE_REQUEST',default=>'CONSULTATION'};
        ...
        $record=DB::transaction(function()use($data){
            ...
            $code=match($data['request_subtype']){'SPARE_PARTS_QUOTE'=>'UNQ-','MAINTENANCE_CONTRACT_QUOTE'=>'UNM-','TECHNICAL_VISIT'=>'UNQ-','ROUTINE_MAINTENANCE'=>'UNRM-','URGENT_MAINTENANCE'=>'UNUM-',default=>'UNC-'};
