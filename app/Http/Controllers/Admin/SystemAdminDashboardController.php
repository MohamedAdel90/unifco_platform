...
class SystemAdminDashboardController extends Controller
{
    public function __invoke(Request $request): View
    {
        ...
        $degraded = $failedJobs > 0 || (Schema::hasTable('security_events') && DB::table('security_events')->where('tenant_id', $tenantId)->where('status', 'OPEN')->where('severity', 'HIGH')->exists());
        ...
        $kpis = [
            ...
            'system_alerts' => $alerts, 'integrations' => $integrations,
        ];
