...
class BrandingPresentation
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // The public home page still receives the shared icon navigation treatment.
        // Request-service owns its complete presentation in request.blade.php and must
        // never be rewritten here; this prevents the native centered CTA/header from
        // being replaced after Blade has rendered it.
...
/* Public footer only. Header sizing stays owned by each public page template. */
...
/* Homepage primary navigation icons. */
...
@media(max-width:1180px){
  .public-primary-nav{gap:12px!important}
  .public-primary-nav>a{font-size:10px!important;min-width:48px!important}
  .public-primary-nav .nav-icon,.public-primary-nav .nav-icon svg{width:18px!important;height:18px!important}
}
