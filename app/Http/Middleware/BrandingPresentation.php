    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($request->routeIs('public.home')) {
            ...
            $navigation = '<nav class="nav-links public-primary-nav">'
                ...
                .'<a href="#industries">'.$labels['clients'].'</a>'
...
/* Homepage primary navigation: requested seven-item menu only. */
.public-primary-nav{gap:18px!important;overflow:visible!important}
.public-primary-nav>a{font-size:11px!important}
...
@media(max-width:1180px){
  .public-primary-nav{gap:13px!important}
  .public-primary-nav>a{font-size:10px!important}
}
