    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($request->routeIs('public.home')) {
            ...
            $icons = [
                ...
                'clients' => '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="7" r="3"/><circle cx="5.5" cy="9.5" r="2"/><circle cx="18.5" cy="9.5" r="2"/><path d="M7 20c.4-4 2.1-6 5-6s4.6 2 5 6M2.5 18c.2-2.8 1.4-4.2 3.6-4.2M21.5 18c-.2-2.8-1.4-4.2-3.6-4.2"/><path d="m12 15.8.8 1.7 1.9.2-1.4 1.3.4 1.8-1.7-.9-1.7.9.4-1.8-1.4-1.3 1.9-.2z"/></svg>',
...
/* Homepage primary navigation: professional outline icons + labels. */
