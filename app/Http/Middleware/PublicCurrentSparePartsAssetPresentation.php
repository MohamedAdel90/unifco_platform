...
class PublicCurrentSparePartsAssetPresentation
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $style = <<<'HTML'
<style id="unifco-current-spare-parts-asset-v3">
...
HTML;
        ...
        $script = <<<'HTML'
<script id="unifco-current-spare-parts-asset-script-v3">
(()=>{
 ...
 const target=()=>service.value==='quotation'&&subtype.value==='parts'&&!!customerNo?.value&&!!contract?.value&&!!assetId.value&&!$('uf-manual')?.classList.contains('show');
