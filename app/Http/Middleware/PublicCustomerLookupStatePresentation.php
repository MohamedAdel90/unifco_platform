...
class PublicCustomerLookupStatePresentation
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $style = <<<'HTML'
<style id="unifco-customer-lookup-state-v10">
...
.lookup-row{display:grid!important;grid-template-columns:20% 16% 24% 1fr!important;align-items:center!important;gap:8px!important;width:100%!important;max-width:100%!important;min-width:0!important;overflow:hidden!important;box-sizing:border-box!important;direction:rtl!important}
...
#customer-lookup-state-indicator{grid-column:3!important;box-shadow:none!important;pointer-events:none!important}
...
@media(max-width:700px){.lookup-row{grid-template-columns:30% 24% 40% 1fr!important;gap:5px!important}#customer_number,#customer-lookup,#customer-lookup-state-indicator{height:40px!important;min-height:40px!important}#customer-lookup,#customer-lookup-state-indicator{padding:0 4px!important;gap:2px!important;font-size:clamp(6px,1.55vw,8px)!important}#customer-lookup .lookup-refresh{font-size:10px!important}}
@media(max-width:430px){.lookup-row{grid-template-columns:31% 25% 40% 1fr!important;gap:4px!important}#customer-lookup,#customer-lookup-state-indicator{padding:0 2px!important;font-size:clamp(5.8px,1.8vw,7.5px)!important}}
</style>
HTML;
        $script = <<<'HTML'
<script id="unifco-customer-lookup-state-script-v10">
