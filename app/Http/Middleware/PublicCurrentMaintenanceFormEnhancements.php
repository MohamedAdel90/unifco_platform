...
@media(max-width:850px){.uf-customer-card>.grid,.uf-current-customer-details{grid-template-columns:1fr 1fr!important}.uf-current-customer-details .field.address{grid-column:span 2!important}}
@media(max-width:700px){#routine-form .lookup-row,.uf-customer-card .lookup-row{align-items:stretch!important;flex-wrap:wrap!important}#routine-form #customer_number,.uf-customer-card #customer_number{width:100%!important;flex:1 1 100%!important}#routine-form #customer-lookup,.uf-customer-card #customer-lookup{width:100%!important;min-width:0!important}.uf-customer-card>.grid,.uf-current-customer-details{grid-template-columns:1fr!important}.uf-current-customer-details .field.address{grid-column:auto!important}}
</style>
HTML;
...
(function(){
  ...
  ready(function(){
    ...
    /* Do not re-parent the customer card. Moving it out of #routine-form caused
       Safari/iOS to paint the first card while the remainder of the form stayed
       hidden or appeared much later after other presentation scripts ran. */
    ...
    document.querySelectorAll('.uf-customer-card .field > label').forEach(function(label){
      ...
      s.innerHTML='<svg viewBox="0 0 24 24">'+person+'</svg>';
