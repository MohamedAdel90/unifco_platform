...
.up-hero{display:grid;grid-template-columns:.88fr 1.12fr;gap:28px;align-items:start}
...
@media(max-width:980px){#unifco-profile-modal{padding:14px}.unifco-profile-sheet{padding:20px}.up-hero{grid-template-columns:1fr}.up-visual{order:2}.up-copy{order:1}.up-values{grid-template-columns:repeat(4,1fr)}.up-cards{grid-template-columns:1fr}.up-card{min-height:auto}.up-title{font-size:42px}}
...
<div class="unifco-profile-sheet" dir="ltr">
  <section class="up-hero"><div class="up-visual"><div class="up-brand"><img src="/images/unifco-logo.webp" alt="UNIFCO"></div><div class="up-photo"><img src="/images/home/about-technician-v14.webp" alt="UNIFCO Facilities Management"></div></div><div class="up-copy"><div class="up-title-block"><div class="up-kicker">UNIFCO</div><h2 class="up-title">Who We Are</h2><div class="up-subtitle">Facilities Management</div></div><p>UNIFCO is a Saudi facilities management company specializing in operations, maintenance and construction, delivering dependable services through experienced teams, professional management and supporting technology.</p></div></section>
</div>
HTML;
