...
.unifco-profile-dialog-artwork{width:min(1536px,96vw,calc(94vh * 1.5));max-height:none;overflow:hidden;border:0;border-radius:18px;background:transparent;box-shadow:none}
.unifco-profile-dialog-artwork .unifco-profile-close{position:absolute;left:5.9%;top:4.5%;width:4%;min-width:38px;max-width:54px;aspect-ratio:1;height:auto;margin:0;opacity:0;background:transparent;border:0;box-shadow:none;cursor:pointer}
.unifco-profile-artwork{width:100%;aspect-ratio:3/2;overflow:hidden}.unifco-profile-artwork img{display:block;width:100%;height:100%;object-fit:contain}
body.unifco-profile-open{overflow:hidden}
@media(max-width:980px){#unifco-profile-modal{padding:14px}.unifco-profile-sheet{padding:20px}.up-hero{grid-template-columns:1fr;direction:rtl}.up-visual{order:2}.up-copy{order:1}.up-values{grid-template-columns:repeat(4,1fr)}.up-cards{grid-template-columns:1fr}.up-card{min-height:auto}.up-title{font-size:42px}.unifco-profile-dialog-artwork{width:min(96vw,calc(94vh * 1.5))}}
@media(max-width:620px){#unifco-profile-modal{padding:6px}.unifco-profile-dialog{width:100%;max-height:97vh;border-radius:13px}.unifco-profile-close{top:8px;margin:8px 0 -48px 8px;width:38px;height:38px}.unifco-profile-sheet{padding:14px 12px}.up-topline{margin-right:48px;font-size:8px}.up-title-row{display:block}.up-side-note{display:none}.up-title{font-size:34px}.up-subtitle{font-size:16px}.up-copy>p,.up-quote{font-size:11px}.up-brand img{width:160px}.up-photo,.up-photo img{min-height:245px;height:245px}.up-photo-copy{font-size:21px;top:72px;left:20px}.up-values{grid-template-columns:repeat(2,1fr)}.up-value{border-bottom:1px solid #e4e8ee}.up-cards{gap:10px}.up-card{padding:15px}.up-card-head h3{font-size:19px}.unifco-profile-dialog-artwork{width:min(98vw,calc(96vh * 1.5));border-radius:10px}.unifco-profile-dialog-artwork .unifco-profile-close{min-width:30px}}
</style>
HTML;
...
HTML;
        ...
        $englishBody = <<<'HTML'
<div class="unifco-profile-artwork" dir="ltr">
...
HTML;
        ...
        $dialogClass = $isArabic ? 'unifco-profile-dialog' : 'unifco-profile-dialog unifco-profile-dialog-artwork';
        $modal = '<div id="unifco-profile-modal" aria-hidden="true" role="dialog" aria-modal="true"><div class="'.$dialogClass.'"><button type="button" class="unifco-profile-close" data-unifco-profile-close aria-label="'.e($close).'">×</button>'.$body.'</div></div>';
