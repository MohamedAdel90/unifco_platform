...
'اختر نوع العميل أولًا، ثم الخدمة ونوع الطلب. يتم عرض النموذج المناسب أسفل هذا السطر.':'Choose the customer type, service, and request type. The appropriate form will appear below.','هذا النوع تم اعتماده للتطوير اللاحق. لم يتم تغيير أي نموذج آخر بالموقع.':'This request type is scheduled for a later development phase.','بيانات العميل':'Customer Information','بيانات العميل الحالي':'Existing Customer Information','رقم العميل':'Customer Number','مثال: CUS-00125':'Example: CUS-00125','جلب البيانات':'Retrieve Details','يتم جلب بيانات العميل تلقائيًا بعد إدخال رقم العميل.':'Customer details are retrieved automatically after entering the customer number.','بانتظار إدخال رقم العميل':'Waiting for customer number','أدخل رقم العميل ثم اضغط «جلب البيانات» لعرض معلوماته هنا.':'Enter the customer number, then select Retrieve Details to view the customer information.','تم التحقق من العميل':'Customer verified','تم التحقق':'Verified','تم جلب بيانات العميل بنجاح.':'Customer details retrieved successfully.','مسؤول التواصل':'Contact Person','رقم الجوال':'Mobile Number','البريد الإلكتروني':'Email Address','المدينة':'City','العنوان المختصر':'Short Address','↻ تغيير العميل':'↻ Change Customer',
...
'بيانات العميل الجديد':'New Customer Information','اسم المنشأة / الشركة':'Company / Organization Name','اسم الشركة / المنشأة':'Company / Organization Name','اسم مسؤول التواصل':'Contact Name','اسم المسؤول':'Contact Name','الاسم الكامل':'Full name','اسم المنشأة':'Organization name','المنطقة':'Region','اختر المنطقة':'Select Region','اختر المدينة':'Select City','الحي':'District','اسم الحي':'District name','العنوان المختصر / الوطني':'Short / National Address','العنوان أو رقم العنوان المختصر':'Address or short-address code','العنوان التفصيلي':'Detailed Address','⌖ استخدم موقعي الحالي':'⌖ Use My Current Location','استخدم موقعي الحالي':'Use My Current Location','يمكن تحديد الموقع لتسريع تسجيل موقع الخدمة.':'Location can be shared to speed up service-site registration.','موقع المنشأة':'Facility Location','المعدة وبياناتها':'Equipment Information','أدخل بيانات المعدة مباشرة.':'Enter the equipment information directly.','اختر نوع المعدة':'Select Equipment Type','تكييف وتهوية':'HVAC','كهرباء':'Electrical','مولد':'Generator','مضخة':'Pump','نظام مكافحة حريق':'Fire Protection System','سباكة':'Plumbing','مصعد':'Elevator','أخرى':'Other','رقم / اسم الموديل':'Model number / name','رقم الأصل إن وجد':'Asset Number (if available)','حالة المعدة':'Equipment Status','اختر الحالة':'Select Status','تعمل جزئيًا':'Partially Running','تعمل مع وجود عطل':'Running with an Issue','غير محدد':'Not Specified',
