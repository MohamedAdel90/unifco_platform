...
class PublicHomeCmsMediaPresentation
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $override = '<style id="unifco-cms-about-media">'
            ...
            .'.portal-card{border:1px solid #dfe6ef!important;border-radius:16px!important;background:linear-gradient(145deg,#fff,#f8fafc)!important;box-shadow:0 18px 42px rgba(7,31,77,.10)!important}'
            .'.portal-card .check{display:flex!important;align-items:center!important;gap:9px!important;font-weight:800!important;color:#071f4d!important}'
            .'.portal-card .check:before{content:""!important;width:34px!important;height:34px!important;flex:0 0 34px!important;background:#d80f2d!important;background-repeat:no-repeat!important;background-position:center!important;background-size:19px 19px!important}'
            .'.portal-card .check:nth-child(1):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Cpath d=%27M6 3h12v18H6zM9 7h6M9 11h6M9 15h4%27/%3E%3C/svg%3E")!important}'
            .'.portal-card .check:nth-child(2):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Cpath d=%27M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.2 2.2-3-3z%27/%3E%3C/svg%3E")!important}'
            .'.portal-card .check:nth-child(3):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Crect x=%273%27 y=%275%27 width=%2718%27 height=%2716%27 rx=%272%27/%3E%3Cpath d=%27M7 3v4M17 3v4M3 10h18%27/%3E%3C/svg%3E")!important}'
            .'.portal-card .check:nth-child(4):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Cpath d=%27M4 21V8l8-4 8 4v13M9 21v-5h6v5M8 10h.01M12 10h.01M16 10h.01%27/%3E%3C/svg%3E")!important}'
            .'.portal-card .check:nth-child(5):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Cpath d=%27M6 3h12v18H6zM9 7h6M9 11h6M9 15h4%27/%3E%3Cpath d=%27M15 17h3%27/%3E%3C/svg%3E")!important}'
            .'.portal-card .check:nth-child(6):before{background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%272%27%3E%3Cpath d=%27M4 20V10M10 20V4M16 20v-7M22 20H2%27/%3E%3C/svg%3E")!important}'
            .'.portal-device{width:94%!important;height:auto!important;max-height:280px!important;margin:22px auto 4px!important;filter:drop-shadow(0 20px 24px rgba(9,29,58,.18))!important}'
            .'</style>';
