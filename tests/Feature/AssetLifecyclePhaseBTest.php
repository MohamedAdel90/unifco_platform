...
class AssetLifecyclePhaseBTest extends TestCase
{
    ...
    private function asset(array $d): Asset
    {
        $this->actingAs($d['engineer'])->post('/asset-master',[
            'customer_id'=>$d['customer']->id,'customer_site_id'=>$d['site']->id,'name'=>'Generator GEN-01','customer_asset_code'=>'GEN-01',
            'asset_category'=>'Electrical','asset_type'=>'Diesel Generator','manufacturer'=>'Caterpillar','model_no'=>'C18','serial_no'=>'GEN-B-001',
        ...
        return Asset::where('serial_no','GEN-B-001')->firstOrFail();
    }
