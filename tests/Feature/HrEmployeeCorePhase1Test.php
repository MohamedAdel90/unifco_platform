...
class HrEmployeeCorePhase1Test extends TestCase
{
    ...
    public function test_hr_dashboard_and_employee_directory_render_new_ui(): void
    {
        ...
        $this->actingAs($admin)->get('/hr/dashboard')->assertOk()->assertSee('HR Command Center',false)->assertSee('Monthly Compensation',false)->assertSee('/hr/operations#attendance',false)->assertSee('/hr/operations#leave',false)->assertSee('/hr/operations#payroll',false);
