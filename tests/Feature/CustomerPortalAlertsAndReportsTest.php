...
class CustomerPortalAlertsAndReportsTest extends TestCase
{
    ...
    public function test_due_maintenance_alert_and_technical_report_pdf_are_customer_scoped(): void
    {
        ...
        $this->actingAs($user)->get('/customer/notifications')->assertOk()->assertSee('PM-DUE')->assertSee('Maintenance due');
        $this->actingAs($user)->get('/customer/reports')->assertOk()->assertSee('TVR-1')->assertSee('PREVENTIVE')->assertSee('Tech');
