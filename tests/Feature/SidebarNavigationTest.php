...
class SidebarNavigationTest extends TestCase
{
    ...
    public function test_sidebar_enhancer_is_available_outside_dashboard(): void { $this->actingAs($this->admin())->get('/workspace/asset-360')->assertOk()->assertSee('Asset 360',false)->assertSee('unifco-language-switcher',false)->assertSee('/workspace/predictive-analytics',false); }
