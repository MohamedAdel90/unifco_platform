...
class SidebarNavigationTest extends TestCase
{
    ...
    public function test_operational_wave_routes_are_registered(): void { $this->assertTrue(\Route::has('inventory.operations.index')); $this->assertTrue(\Route::has('procurement.operations.index')); $this->assertTrue(\Route::has('hr.operations.index')); $this->assertTrue(\Route::has('manufacturing.operations.index')); $this->assertTrue(\Route::has('maintenance.operations.index')); $this->assertTrue(\Route::has('workspace.show')); }
