...
class CustomerPortalExecutiveDashboardTest extends TestCase
{
    public function test_customer_portal_dashboard_contains_approved_executive_sections_and_drilldowns(): void
    {
        ...
        foreach (['Service Request Status','Work Orders Status','Asset Health','Monthly Activity','Contracts & SLA','Financial Summary','Request Trend','Needs Attention','Quick Actions','New Service Request','Emergency Maintenance','Request Quotation','Request Spare Parts','Technical Consultation'] as $section) {
