...
class BrandingSettingsTest extends TestCase
{
    ...
    public function test_logo_presentation_rules_are_injected_into_login_and_public_html(): void
    {
        ...
        $this->get('/')->assertOk()
            ...
            ->assertSee('nav-dropdown-menu',false)
            ->assertSee('القطاعات',false)
            ->assertSee('مراكز البيانات',false)
            ->assertSee('المرافق',false)
        ...
        $this->get('/?lang=en')->assertOk()
            ...
            ->assertSee('Industrial',false)
            ->assertSee('Commercial',false)
            ->assertSee('Data Centers',false)
            ->assertSee('Hospitals',false)
            ->assertSee('Hotels',false)
