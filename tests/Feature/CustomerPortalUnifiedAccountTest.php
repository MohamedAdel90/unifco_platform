...
class CustomerPortalUnifiedAccountTest extends TestCase
{
    ...
    public function test_customer_pages_share_the_unified_portal_shell(): void
    {
        ...
        $this->actingAs($user)->get('/customer/profile?lang=en')->assertOk()->assertSee('UNIFIED CUSTOMER ACCOUNT')->assertSee('Login &amp; Security',false)->assertSee('Unified customer account');
