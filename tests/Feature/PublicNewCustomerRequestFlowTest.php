...
class PublicNewCustomerRequestFlowTest extends TestCase
{
    public function test_new_customer_flow_uses_direct_equipment_card_and_keeps_shared_request_cards(): void
    {
        $this->get('/request-service')
            ...
            ->assertSee('body.uf-new-customer-mode .uf-workspace{display:grid!important;grid-template-columns:1fr!important;grid-template-areas:"asset" "details"!important;gap:16px!important;align-items:start!important;direction:rtl!important', false)
