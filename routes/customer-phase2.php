...
use App\Http\Controllers\{CustomerActionCenterController,CustomerGlobalSearchController,CustomerPortalPhase2ActionController};
use App\Http\Controllers\Workflow\CustomerActionInboxController;
use Illuminate\Support\Facades\Route;

Route::middleware('auth')->group(function () {
    Route::get('/customer/search', CustomerGlobalSearchController::class)->name('customer.search');
