...
Route::get('/request-service/current-maintenance/asset-parts', CurrentCustomerAssetPartsController::class)->middleware('throttle:60,1')->name('public.current-maintenance.asset-parts');
