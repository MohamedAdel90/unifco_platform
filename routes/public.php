...
Route::get('/request-quote', [PublicSiteController::class, 'quote'])->middleware([PublicSparePartsRequestCompatibility::class, PublicSparePartsRequestPresentation::class])->name('public.quote');
Route::get('/request-service', [PublicSiteController::class, 'quote'])->middleware([PublicSparePartsRequestCompatibility::class, PublicSparePartsRequestPresentation::class])->name('public.request-service');
