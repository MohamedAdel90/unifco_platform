...
<div class="ops-shell">
    ...
    <section class="ops-panel">
        <form method="get" class="ops-toolbar">
            ...
            <select name="stage"><option value="">All workflow stages</option>@foreach(['TRIAGE','EMERGENCY_DISPATCH','PROJECT_MANAGER_REVIEW','TECHNICIAN_ASSIGNMENT','EXECUTION','QUALITY_VERIFICATION','HSE_VERIFICATION','CUSTOMER_ACCEPTANCE','FINANCE_REVIEW','CLOSURE','CSAT','COMPLETED'] as $v)<option @selected(request('stage')===$v)>{{ $v }}</option>@endforeach</select>
            ...
            @forelse($requests as $item)
                ...
                <tr>
                    ...
                    <td class="ops-actions">
                        <a class="ops-link" href="{{ route('service-requests.workflow.show',$item) }}">Open Workflow</a>
