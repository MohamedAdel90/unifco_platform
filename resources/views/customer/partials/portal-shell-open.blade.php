...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--ink)}a{text-decoration:none;color:inherit}button,input,select,textarea{font:inherit}.ui-icon{width:18px;height:18px;display:block;flex:0 0 auto}
        .portal-app{min-height:100vh;display:grid;grid-template-columns:264px minmax(0,1fr)}.portal-sidebar{position:sticky;top:0;height:100vh;background:linear-gradient(180deg,var(--navy),var(--navy-deep));color:#fff;padding:14px 12px 12px;display:flex;flex-direction:column;z-index:30;overflow:hidden}.portal-account{padding:5px 8px 12px;border-bottom:1px solid #ffffff1a}.portal-account-row{display:flex;align-items:center;gap:10px}.portal-logo{width:38px;height:38px;border-radius:11px;background:#fff;color:var(--navy);display:grid;place-items:center;font-weight:900;font-size:11px}.portal-account strong{font-size:12px;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.portal-account small{font-size:9px;color:#aebed4;display:block;margin-top:3px}.portal-role{display:inline-flex;margin-top:9px;padding:5px 8px;border-radius:6px;background:#ffffff1a;color:#dce7f4;font-size:8px;font-weight:800;letter-spacing:.05em}.portal-create{display:grid;grid-template-columns:1fr 38px 38px;gap:6px;margin:11px 4px 4px}.portal-create a,.portal-create button{height:37px;border:0;border-radius:8px;display:flex;align-items:center;justify-content:center;gap:7px;font-size:9px;font-weight:850;cursor:pointer}.portal-create .primary{background:#fff;color:var(--navy)}.portal-create .emergency{background:var(--red);color:#fff}.portal-create .collapse{background:#ffffff1a;color:#fff}.portal-search{margin:8px 4px 4px;height:35px;border:1px solid #ffffff1f;border-radius:9px;display:flex;align-items:center;gap:8px;padding:0 9px}.portal-search input{min-width:0;width:100%;border:0;background:transparent;color:#fff;font-size:9px;outline:0}.portal-search input::placeholder{color:#aebed4}.portal-nav{min-height:0;overflow:auto;padding:2px 2px 10px;scrollbar-width:thin;scrollbar-color:#ffffff2e transparent}.portal-group{margin-top:11px}.portal-group-title{padding:0 10px 4px;color:#7f98b9;font-size:8px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.portal-link{min-height:34px;display:flex;gap:10px;align-items:center;padding:8px 10px;border-radius:8px;font-size:10px;color:#eaf1fa;margin:2px 0}.portal-link:hover,.portal-link.active{background:#ffffff21;color:#fff}.portal-link.active{box-shadow:inset 3px 0 0 var(--red)}[dir=rtl] .portal-link.active{box-shadow:inset -3px 0 0 var(--red)}.portal-link span:nth-child(2){min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.portal-badge{margin-inline-start:auto;min-width:19px;height:18px;padding:0 5px;border-radius:9px;background:#ffffff20;display:grid;place-items:center;font-size:8px;font-weight:800}.portal-badge.urgent{background:var(--red)}.portal-footer{margin-top:auto;padding-top:8px;border-top:1px solid #ffffff1a}.portal-footer button{width:100%;border:1px solid #ffffff33;background:transparent;color:#fff;padding:9px;border-radius:8px;cursor:pointer;font-size:9px}.portal-app.sidebar-collapsed{grid-template-columns:82px minmax(0,1fr)}.portal-app.sidebar-collapsed .portal-account strong,.portal-app.sidebar-collapsed .portal-account small,.portal-app.sidebar-collapsed .portal-role,.portal-app.sidebar-collapsed .portal-group-title,.portal-app.sidebar-collapsed .portal-link span:nth-child(2),.portal-app.sidebar-collapsed .portal-badge,.portal-app.sidebar-collapsed .portal-search input,.portal-app.sidebar-collapsed .portal-create .primary span{display:none}.portal-app.sidebar-collapsed .portal-account-row,.portal-app.sidebar-collapsed .portal-link{justify-content:center}.portal-app.sidebar-collapsed .portal-create{grid-template-columns:1fr}.portal-app.sidebar-collapsed .portal-create a,.portal-app.sidebar-collapsed .portal-create button{width:38px;margin:auto}
