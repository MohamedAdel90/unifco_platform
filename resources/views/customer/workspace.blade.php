...
@endif
            ...
            @if($section === 'reports')
                ...
                <div class="page-head reports-page-head">
                    ...
                    <div class="reports-head-actions"><a class="btn reports-export" href="#reports-table">Export / Download</a></div>
                </div>
                ...
                <div class="card panel reports-tools">
                    <label class="reports-search"><span>Search reports</span><input id="reports-search" type="search" placeholder="Report number, type or technician..."></label>
                    ...
                    <button type="button" class="filter-button reports-reset" id="reports-reset">Reset</button>
                </div>
                ...
                <style>
                    .reports-head-actions{display:flex;gap:8px}.reports-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:12px}.reports-kpi{padding:15px;display:flex;align-items:center;gap:12px;min-height:105px}.reports-kpi-icon,.reports-empty-icon{width:42px;height:42px;border-radius:12px;background:#eaf3ff;color:var(--blue);display:grid;place-items:center;flex:0 0 auto}.reports-kpi-icon .ui-icon,.reports-empty-icon .ui-icon{width:21px;height:21px}.reports-kpi small{display:block;font-size:9px;font-weight:800;color:#53647a}.reports-kpi b{display:block;font-size:25px;line-height:1;margin:7px 0}.reports-kpi em{display:block;font-style:normal;font-size:8px;color:var(--muted)}.reports-tools{display:flex;align-items:end;gap:10px;margin-bottom:12px}.reports-search{flex:1}.reports-search span{display:block;font-size:8px;color:var(--muted);font-weight:800;margin-bottom:5px}.reports-search input{width:100%;height:34px;border:1px solid var(--line);border-radius:8px;padding:0 11px;font-size:9px}.reports-table td strong{color:var(--blue)}.reports-mobile{display:none}.reports-empty{min-height:280px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:30px}.reports-empty-icon{width:58px;height:58px;border-radius:16px}.reports-empty-icon .ui-icon{width:29px;height:29px}.reports-empty strong{font-size:14px;margin:14px 0 5px}.reports-empty p{max-width:440px;color:var(--muted);font-size:9px;line-height:1.6;margin:0}.reports-insights{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:12px}.reports-type-list{display:grid;gap:10px}.reports-type-list>div{display:grid;grid-template-columns:130px 1fr 28px;align-items:center;gap:10px;font-size:9px}.reports-type-list b{text-align:right}.reports-bar{height:7px;background:#edf1f5;border-radius:999px;overflow:hidden}.reports-bar i{display:block;height:100%;background:var(--blue);border-radius:inherit}.report-card{padding:13px}.report-card-head{display:grid;grid-template-columns:auto 1fr auto;gap:10px;align-items:center}.report-card-head strong{display:block;font-size:11px;color:var(--blue)}.report-card-head small{display:block;font-size:8px;color:var(--muted);margin-top:3px}.report-card-meta{display:flex;justify-content:space-between;gap:10px;margin:11px 0;color:var(--muted);font-size:8px}.report-card .btn{display:block;text-align:center}
                    @media(max-width:1000px){.reports-kpis{grid-template-columns:1fr 1fr}}
