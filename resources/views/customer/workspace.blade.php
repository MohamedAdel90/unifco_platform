...
@endif
            ...
            @if($section === 'quotations')
                ...
                @media(max-width:520px){.quote-page-head h2{font-size:27px}.quote-kpis{gap:8px}.quote-kpi{min-height:100px;padding:10px;gap:8px}.quote-kpi-icon{width:34px;height:34px}.quote-kpi b{font-size:19px}.quote-kpi strong{font-size:8px}.quote-kpi small{font-size:7px}.quote-tools{padding:9px}.quote-tools .filter-button{width:100%}.quote-card .quote-decision{margin-top:10px;display:grid;grid-template-columns:1fr 1fr}.quote-card .quote-decision input{max-width:none}.quote-card .quote-decision .btn{grid-column:1/-1}.quote-insights{gap:8px}.quote-type-list>div{grid-template-columns:90px 1fr 20px}}
                </style>
