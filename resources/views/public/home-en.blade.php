...
$home = [
    ...
    'carousel_previous' => 'Previous items','carousel_next' => 'Next items',
    'projects_title' => 'Our work in action','projects_button' => 'View All Projects',
    'clients_title' => 'Our Clients and Success Partners','clients_text' => 'We are proud to support leading government and private-sector organizations across multiple industries.',
    'showcase_clients' => [['/images/home/clients/nwc.webp','National Water Company'],['/images/home/clients/hrsd.webp','Ministry of Human Resources and Social Development'],['/images/home/clients/islamic-university.webp','Islamic University of Madinah'],['/images/home/clients/ministry-health.webp','Ministry of Health'],['/images/home/clients/uae-embassy.webp','Embassy of the United Arab Emirates'],['/images/home/clients/stc.webp','STC'],['/images/home/clients/almarai.webp','Almarai'],['/images/home/clients/sdb.webp','Social Development Bank']],
    'more_clients' => 'More organizations','all_clients' => 'View All Clients',
    'emergency_title' => 'Need urgent support?','emergency_text' => 'If a failure is affecting operations, send an emergency maintenance request for immediate routing.','emergency_button' => 'Emergency Maintenance','emergency_contact' => '24/7 operations support · Send your urgent request directly',
    'emergency_photo_alt' => 'UNIFCO field team at an operating site','operations_support' => 'Operations support','contact_now' => 'Call us now','email_us' => 'Email us',
