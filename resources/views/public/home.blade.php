...
$home = [
    ...
    'hero_text' => 'حلول متكاملة للأنظمة الكهربائية والطاقة والصيانة وإدارة المرافق والأصول، مع فرق متخصصة ومتابعة رقمية تدعم استمرارية التشغيل بأعلى كفاءة.',
    ...
    'services_title' => 'خدمات كهربائية وصيانة وإدارة مرافق متكاملة',
    'services_text' => 'من أنظمة الطاقة الحرجة والصيانة المتخصصة إلى إدارة الأصول والمرافق',
    'services' => [
        ['01', '/images/home/transformer.svg', 'Transformers · المحولات الكهربائية', 'فحص وصيانة وتشغيل المحولات الكهربائية ورفع الاعتمادية وكفاءة التشغيل.'],
        ['02', '/images/home/ups.svg', 'UPS Systems', 'توريد وفحص وصيانة أنظمة UPS والطاقة غير المنقطعة للأنظمة الحرجة.'],
        ['03', '/images/home/generator.svg', 'Generators · المولدات', 'صيانة وفحص وتشغيل المولدات وأنظمة القدرة الاحتياطية ودعم استمرارية الطاقة.'],
        ['04', '/images/home/mv-switchgear.svg', 'MV Systems · أنظمة الجهد المتوسط', 'خدمات أنظمة الجهد المتوسط واللوحات والحماية والاختبارات والتشغيل.'],
        ['05', '/images/home/service-preventive.svg', 'Preventive Maintenance', 'برامج صيانة وقائية دورية تقلل الأعطال وتحسن جاهزية الأصول والمعدات.'],
        ['06', '/images/home/service-corrective.svg', 'Corrective / Emergency Maintenance', 'استجابة للأعطال والصيانة التصحيحية والطارئة لإعادة التشغيل بأسرع وقت ممكن.'],
        ['07', '/images/home/service-inspection.svg', 'Inspection & Testing', 'فحص واختبار الأنظمة والمعدات الكهربائية وإصدار تقارير فنية واضحة.'],
        ['08', '/images/home/service-contracts.svg', 'Maintenance Contracts', 'عقود صيانة دورية بمستويات خدمة وجداول واضحة ومتابعة وتقارير مستمرة.'],
        ['09', '/images/home/service-industrial-electrical.svg', 'Industrial / Commercial Electrical Services', 'خدمات كهربائية متخصصة للمنشآت الصناعية والتجارية والمواقع التشغيلية.'],
        ['10', '/images/home/service-asset-management.svg', 'Asset Management', 'إدارة دورة حياة الأصول وسجلات الصيانة والضمانات والتاريخ الفني.'],
        ['11', '/images/home/service-hvac.svg', 'HVAC Systems', 'فحص وصيانة وتشغيل أنظمة التكييف والتهوية وتحسين كفاءة الأداء.'],
        ['12', '/images/home/service-mep.svg', 'MEP Services', 'صيانة وتشغيل الأنظمة الميكانيكية والكهربائية والصحية للمباني والمنشآت.'],
        ['13', '/images/home/service-facility-management.svg', 'Facility Management', 'إدارة وتشغيل المرافق والخدمات اليومية ومتابعة الأصول والمقاولين والأداء.'],
    ],
    'more' => 'المزيد',
